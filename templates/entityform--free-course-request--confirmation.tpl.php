...
<div class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content fcr-receipt"<?php print $content_attributes; ?>>
    <div class="content--main block--field-text">
      ...
      <div><?php print render($content['field_tr_grade']); ?></div>
      <div><?php print render($content['field_tr_name']); ?></div>
      <div><?php print render($content['field_tr_phone']); ?></div>
      <div><?php print render($content['field_tr_mail']); ?></div>
    </div>
